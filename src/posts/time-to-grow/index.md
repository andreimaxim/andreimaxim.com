...
title: Time to Grow
date: 2026-02-08
description: A personal take on LLMs as the next technological leap and why it's a chance to grow, not something to fear.
---

In the early '90s, my grandmother, who was an accountant back then, would wake up at 4 AM to work on account reconciliation.
...
the data she'd dictate from a piece of paper as I was typing much faster and we'd be done in half an hour. If there was an issue
with a line item, we'd find it in minutes. Of course, there were some times where the idiosyncrasies built into Excel would
